        ...
        <div className="w-full rounded-3xl">
          ...
          <div className="mt-36 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 -mb-[7rem]">
            <div className="flex gap-[5rem]">
                <span onClick={()=>setCommunityActive(false)} > <ButtonWC type={"Created"} insideImg={coinsCreated} width={50} /></span>
                <span onClick={()=>setCommunityActive(false)} > <ButtonWC type={"Held"} insideImg={coinsHeld} width={50} /></span>
                <span onClick={()=>setCommunityActive(true)} > <ButtonWC type={"Posts"} insideImg={work} width={50} /></span>
                <span onClick={()=>setCommunityActive(true)} > <ButtonWC type={"Replies"} insideImg={work} width={50} /></span>
